...
class BTreeIndex {
 ...
 private:
  ...
  BTLeafNode readFwdNode;
  int cont;
  char buffer[PageFile::PAGE_SIZE]; //initalize buffer
	
  /**
   */
  RC insertHelper(PageId rootPid, int key, const RecordId& rid, int height, PageId& newPid, int& sibMidKey);
